    ...
    <>
      ...
      <main className="page narrow">
        ...
        <div className="about-body">
          ...
          <p>I quit pornography (and following that, all other substances, drugs, alcohol) in 2025. I&apos;ve been fully abstaining from all types of sexual pleasure since then in order to heal my brain and redirect my energy towards repairing my life, which is where I am at now, in the forge and repairing as well as building my life mission, &ldquo;Mission Phoenix&rdquo;. I used to write a weekly newsletter, and I now make videos on my YouTube channel instead, containing reflections around pornography addiction, philosophies, ideas, suggestions, tips and anecdotes. There is no AI involved what so ever, it is all me.</p>
          ...
          <p> A creep in the dark will always be a creep in the light. Live your life with integrity, that is what I am doing, and what I want to inspire to the people that I help. </p>
